...
class JsonIconBuilderModel extends JsonWidgetBuilderModel {
    ...
    if (map != null) {
      ...
      if (map is JsonIconBuilderModel) {
        ...
        result = JsonIconBuilderModel(
          args,
          applyTextScaling: JsonClass.maybeParseBool(map['applyTextScaling']),
          blendMode: () {
  ...
  Map<String, dynamic> toJson() {
    return JsonClass.removeNull({
      'applyTextScaling': applyTextScaling,
      'blendMode': ThemeEncoder.encodeBlendMode(blendMode),
      'color': ThemeEncoder.encodeColor(color),
      'fill': fill,
      'fontWeight': ThemeEncoder.encodeFontWeight(fontWeight),
      'grade': grade,
      'icon': ThemeEncoder.encodeIconData(icon),
      'opticalSize': opticalSize,
      'semanticLabel': semanticLabel,
      'shadows': shadows,
      'size': size,
